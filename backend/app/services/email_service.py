...
_TR_DRIP = {
    "day1": {
        ...
        "ar": {
            ...
            "p": [
                "مساحة التجربة هي قلب Vibecraft — تتحدث مباشرةً إلى النماذج، كما في محادثة. اطلب صورة، حسّنها، غيّر الاتجاه، ثم اطلب من جديد. دون إعدادات طويلة.",
...
_TR_DEACTIVATED = {
    ...
    "ar": {
        ...
        "body": "تم إلغاء تنشيط حسابك على Vibecraft، والوصول إليه معطّل الآن. إذا لم تكن أنت من قام بذلك أو كنت ترغب في استعادته، تواصل معنا عبر {support} وسنساعدك.",
...
_TR_SUSPENDED = {
    ...
    "perm": {
        ...
        "ar": {
            ...
            "appeal": "إذا كنت تعتقد أن هذا القرار قد تم عن طريق الخطأ وترغب في الطعن في الإنهاء، يمكنك تقديم طلب مراجعة نهائية إلى فريقنا عبر {support} وسننظر فيه.",
            "signoff": "— فريق الأمان في Vibecraft",
