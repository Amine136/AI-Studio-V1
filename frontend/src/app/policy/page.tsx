    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "When a purchase is refunded, the corresponding credits are removed from your balance. The removal applies to the credits created by that specific purchase, and credits from it that you had already spent are not restored.",
          "If a refunded or disputed purchase had already been partly spent, the difference is recorded as a balance owed on your account. It does not reduce the credits you currently hold; it is deducted from your next credit purchase or redeemed code. Your balance owed is shown in the balance details on the Credits page.",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Lorsqu'un achat est remboursé, les crédits correspondants sont retirés de votre solde. Ce retrait porte sur les crédits créés par cet achat précis, et les crédits issus de cet achat que vous aviez déjà dépensés ne sont pas restitués.",
          "Si un achat remboursé ou contesté avait déjà été partiellement dépensé, la différence est enregistrée comme un solde dû sur votre compte. Elle ne réduit pas les crédits que vous détenez actuellement ; elle est déduite de votre prochain achat de crédits ou code utilisé. Votre solde dû est affiché dans le détail du solde sur la page Crédits.",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "عند استرداد عملية شراء، تُخصم الأرصدة المقابلة من رصيدك. ويستهدف هذا الخصم الأرصدة الناتجة عن عملية الشراء المحددة تلك، ولا تُعاد الأرصدة التي كنت قد أنفقتها بالفعل منها.",
          "إذا كانت عملية الشراء المستردة أو المتنازع عليها قد أُنفقت جزئيًا بالفعل، يُسجَّل الفرق كرصيد مستحق على حسابك. ولا يقلل ذلك من الأرصدة التي تملكها حاليًا؛ بل يُخصم من عملية شراء الأرصدة التالية أو من الرمز الذي تستخدمه. ويظهر الرصيد المستحق ضمن تفاصيل الرصيد في صفحة الأرصدة.",
