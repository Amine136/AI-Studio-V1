      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Link
            ...
            className="group rounded-2xl border border-white/8 bg-[linear-gradient(135deg,rgba(21,27,45,0.96),rgba(12,19,36,0.94))] p-8 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)] transition-all hover:border-[#adc6ff]/30 hover:translate-y-[-2px]"
          >
            <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#23293c] text-[#adc6ff]">
              <span className="material-symbols-outlined text-3xl">chat</span>
            </div>
            <h2 className="font-headline text-3xl font-bold text-white">Simple Chat</h2>
            <p className="mt-4 text-base leading-7 text-[#c2c6d6]">
          ...
          <Link
            href="/studio/create"
            className="group rounded-2xl border border-[#adc6ff]/20 bg-[linear-gradient(135deg,rgba(77,142,255,0.12),rgba(21,27,45,0.94))] p-8 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)] transition-all hover:border-[#adc6ff]/40 hover:translate-y-[-2px]"
          >
            ...
            <h2 className="font-headline text-3xl font-bold text-white">Smart Content Creation</h2>
            <p className="mt-4 text-base leading-7 text-[#c2c6d6]">
