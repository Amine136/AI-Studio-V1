...
export default function LandingPage() {
  ...
  return (
    <main className="bg-[#0c1324] text-[#dce1fb] selection:bg-[#4d8eff]/30">
      <nav className="fixed top-0 z-50 w-full bg-[#0c1324]/80 shadow-xl shadow-blue-900/10 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-5 lg:px-12 lg:py-6">
          ...
          <div className="flex items-center gap-3 lg:gap-6">
            <Link href={loginHref} className="font-headline text-sm tracking-tight text-slate-400 transition-colors duration-300 hover:text-blue-100">
              Log In
            </Link>
            <Link href={primaryHref} className="rounded-md bg-gradient-to-br from-[#adc6ff] to-[#4d8eff] px-5 py-2 text-sm font-medium text-[#002e6a] transition-transform duration-100 active:scale-95 lg:px-6">
              {primaryLabel}
            </Link>
          </div>
        </div>
      ...
      <section className="relative flex min-h-[716px] items-center overflow-hidden px-6 py-24 pt-36 lg:px-12">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center animate-fade-in-up stagger-children">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <a href="#models" className="rounded-md border border-[#424754]/20 bg-[#23293c]/40 px-10 py-4 text-lg font-semibold text-[#dce1fb] backdrop-blur-md transition-colors hover:bg-[#2e3447]/60">
              View Models
            </a>
          </div>
      ...
      <section id="features" className="bg-[#0c1324] px-6 py-24 lg:px-12 lg:py-32">
        <div className="mx-auto max-w-[1440px]">
          <div className="mb-20">
            <h2 className="font-headline text-4xl font-bold tracking-tight">Core Engine</h2>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
            ...
            >
              <div className="grid items-center lg:grid-cols-5">
                ...
                <div className="p-8 lg:col-span-3 lg:p-12 lg:pl-0">
                  <div className="relative mx-auto max-w-[800px] [perspective:1000px]">
                    ...
                    <div className="relative rounded-t-3xl border-x border-t border-white/10 bg-zinc-900 p-3 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5),0_30px_60px_-30px_rgba(173,198,255,0.1)]">
                      <div className="relative flex aspect-[16/10] overflow-hidden rounded-2xl bg-black">
                        <div className="flex w-1/3 flex-col gap-6 bg-[#0c1324] p-6">
      ...
      <section id="models" className="bg-[#0c1324] px-6 py-24 lg:px-12 lg:py-32">
        <div className="mx-auto max-w-[1440px]">
      ...
      <section id="horizon" className="relative overflow-hidden bg-[#0c1324] px-6 py-24 lg:px-12 lg:py-32">
        <div className="relative z-10 mx-auto max-w-[1440px]">
          <div className="mb-24 text-center">
            <h2 className="font-headline text-5xl font-bold tracking-tight">The Horizon</h2>
            <p className="mx-auto mt-6 max-w-xl text-[#c2c6d6]">Engineering the next epoch of AI-driven creative workflows.</p>
          </div>
                  ...
                  {item.side === "left" ? (
                    <>
                      ...
                      <div className="relative">
                        ...
                        <div className={`rounded-xl border border-[#424754]/20 bg-[#191f31] p-8 transition-colors ${item.border}`}>
      ...
      <section className="px-6 py-24 lg:px-12 lg:py-32">
        <div className="mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-[2rem] border border-[#adc6ff]/20 bg-gradient-to-br from-[#4d8eff]/20 to-[#571bc1]/20 p-10 text-center lg:p-16">
      ...
      <footer className="w-full border-t border-slate-800/30 bg-[#0c1324] px-6 py-16 lg:px-12">
