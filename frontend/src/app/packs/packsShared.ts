...
const SECTOR_DESC: Record<Language, Dict> = {
  en: {
    ...
    social: "A consistent, scroll-stopping feed — posts, covers, and quotes.",
  ...
  fr: {
    ...
    social: "Un feed cohérent qui arrête le scroll — posts, covers, citations.",
  ...
  ar: {
    ...
    social: "محتوى متناسق يوقف التمرير — منشورات وأغلفة واقتباسات.",
...
export const PACK_STRINGS: Record<Language, Dict> = {
  en: {
    ...
    moderationUnavailable: "Our safety check is temporarily unavailable. Please try again shortly.",
  ...
  fr: {
    ...
    moderationUnavailable: "Notre contrôle de sécurité est temporairement indisponible. Veuillez réessayer sous peu.",
  ...
  ar: {
    ...
    moderationUnavailable: "فحص الأمان غير متاح مؤقتًا. يرجى المحاولة مرة أخرى بعد قليل.",
